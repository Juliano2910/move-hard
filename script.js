const translations = {
  fr: {
    ...
    proofLabel: 'Who we reach',
    proof1: 'Trail runners et passionnés d’outdoor',
    proof2: 'Coureurs route et performance',
    proof3: 'Cyclistes, pratiquants et fans de culture vélo',
    ecosystemEyebrow: 'Who we are',
    ecosystemTitle: 'Un réseau média sport pensé pour engager, inspirer et activer.',
    ecosystemText: 'Move Hard s’appuie sur trois médias spécialisés et sur une approche éditoriale claire : produire des contenus utiles, crédibles et performants pour les marques qui veulent parler juste dans le sport.',
    ecosystemCard1: 'Médias spécialisés',
    ecosystemCard2: 'Disciplines fortes : trail, running, cycling',
    ecosystemCard3: 'Contenus, storytelling, activations et distribution',
    passionsEyebrow: 'Passions',
    passionsTitle: 'Trois disciplines. Une même exigence éditoriale.',
    ...
    service5Title: 'Couverture événementielle',
    ...
    project1Text: 'Création d’un dispositif éditorial autour d’un lancement orienté trail, avec contenus courts, narration athlète et diffusion ciblée.',
  ...
  en: {
    ...
    heroOverline: 'An independent editorial ecosystem connecting brands with real sports communities.',
    heroTitle: 'The media network for brands that want to move sport forward.',
    ...
    heroSupport: 'Powered by three specialist media brands: Trail Hard, Run Hard and Cycling Hard.',
    ...
    proofLabel: 'Who we reach',
    proof1: 'Trail runners and outdoor enthusiasts',
    proof2: 'Road runners and performance-driven audiences',
    proof3: 'Cyclists, riders and bike culture fans',
    ecosystemEyebrow: 'Who we are',
    ecosystemTitle: 'A sports media network built to engage, inspire and activate.',
    ecosystemText: 'Move Hard brings together three specialist media brands and a clear editorial approach to create content that is useful, credible and effective for brands in sport.',
    ecosystemCard1: 'Specialist media brands',
    ecosystemCard2: 'Core disciplines: trail, running, cycling',
    ecosystemCard3: 'Content, storytelling, activations and distribution',
    passionsEyebrow: 'Passions',
    passionsTitle: 'Three disciplines. One editorial standard.',
    ...
    service4Text: 'Turning a product, race, launch or vision into a precise and compelling story.',
    service5Title: 'Event coverage',
    ...
    project1Text: 'An editorial rollout built around a trail-focused launch, combining short-form content, athlete storytelling and targeted distribution.',
